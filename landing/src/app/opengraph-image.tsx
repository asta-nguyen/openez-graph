...
export default async function OGImage() {
  ...
  if (jbMono400)
    fonts.push({ name: "JetBrains Mono", data: jbMono400, weight: 400, style: "normal" as const });
  if (jbMono600)
    fonts.push({ name: "JetBrains Mono", data: jbMono600, weight: 600, style: "normal" as const });
        ...
        {NODES.map((n, i) => {
          ...
          return (
            <g key={i}>
              ...
              <circle cx={n.x} cy={n.y} r={n.r} fill={color} stroke={stroke} strokeWidth={1} />
            </g>
          );
        })}
      </svg>
