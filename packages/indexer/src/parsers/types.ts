 ...
 * oxc returns this smaller shape (no line ranges — those live on chunks);
 ...
 * Implementations: OxcParser (TS/JS), TreeSitterParser (Python/Go/Rust/C),
 * RegexParser (Python/Go/Rust/C fallback), MarkdownParser, ConfigParser, FallbackParser.
 */
export interface CodeParser {
  /** Parser name for metadata tagging (e.g. "oxc", "tree-sitter", "regex"). */
