...
Instance and singleton methods with the same name intentionally share this graph label;
Ruby visibility and dispatch kind are not modeled separately in this indexing pass.
...
- No call extraction. Ruby permits parenthesis-less calls, so a regex fallback cannot
  distinguish calls from variable/property reads without polluting the graph. The WASM
  path handles call edges.
...
| File                                    | Scope                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tests/ruby-indexer.test.ts` (new)      | `parseRuby` regex fallback: class/module/def extraction, `def self.` qualification, `require_relative` imports, nesting, and no false call edges.                                                                                                                                                                                                                                                                                                                                                     |
...
All test inputs are inline, so no standalone fixtures are required.
